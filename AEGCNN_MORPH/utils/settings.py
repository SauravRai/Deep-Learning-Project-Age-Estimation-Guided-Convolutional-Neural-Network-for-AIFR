...
parser.add_argument('--num_classes', '-c', default = 10000, type = int,
                    metavar = 'N', help = 'Number of Identity classes for FR (default: 10000) Tot:13080')

parser.add_argument('--num_age', '-age', default = 78, type = int,
                    metavar = 'N', help = 'Number of Age classes for FR (default: 62) Tot:62')
...
def init():
    global args
    global device
    args = parser.parse_args('--root_path ../DB/MorphProcessed'.split())
